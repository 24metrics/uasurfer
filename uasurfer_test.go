...
var testUAVars = []struct {
	...
	// Chrome
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{43, 0, 2357, "130"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{19, 0, 1084, "60"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{46, 0, 2490, "76"},
			},
			OS{
	...
	// Chromium (Chrome)
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{18, 0, 1025, "142"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{45, 0, 2454, "85"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{88, 0, 4324, "150"},
			},
			OS{
	...
	// Opera
	{
		...
		UserAgent{
			Browser{
				BrowserOpera, Version{18, 0, 1284, "68"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserOpera, Version{10, 2, 0, "93022"},
			},
			OS{
	...
	// UC Browser
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 0, 1, "275"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 2, 0, "308"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 4, 0, "342"},
			},
			OS{
	...
	// ChromeOS
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{4, 0, 253, "0"},
			},
			OS{
	...
	// BlackBerry
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{7, 2, 1, "0"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{10, 2, 1, "1925"},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserNintendo, Version{1, 0, 0, "7494.us"},
			},
			OS{
				PlatformNintendo, OSNintendo, Version{0, 0, 0, ""},
			},
	...
	// Smart TVs and TV dongles
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{83, 0, 4103, "120"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{31, 0, 1650, "0"},
			},
			OS{
				PlatformLinux, OSAndroid, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{11, 0, 696, "77"},
			},
			OS{
				PlatformLinux, OSAndroid, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{40, 0, 2214, "89"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{25, 0, 1364, "173"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{23, 0, 1271, "97"},
			},
			OS{
				PlatformLinux, OSLinux, Version{0, 0, 0, ""},
			},
	...
	// Spotify (applicable for advertising applications)
	{
		...
		UserAgent{
			Browser{
				BrowserSpotify, Version{1, 0, 9, "133"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{18, 0, 1025, "45"},
			},
			OS{
				PlatformLinux, OSLinux, Version{0, 0, 0, ""},
			}, DeviceComputer,
	...
	// BrowserQQ
	{
		...
		UserAgent{
			Browser{
				BrowserQQ, Version{7, 6, 21433, "400"},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserQQ, Version{9, 0, 2191, "400"},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 1, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{27, 0, 1453, "111"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{30, 0, 1599, "105"},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 4, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{52, 0, 2743, "98"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{10, 1, 0, "4633"},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{7, 1, 0, "7"},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{34, 0, 1847, "120"},
			},
			OS{
				PlatformLinux, OSChromeOS, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{5, 0, 329, "0"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{16, 0, 912, "75"},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 7, 2, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{4, 0, 249, "0"},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 8, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserNintendo, Version{2, 0, 0, "9362.us"},
			},
			OS{
				PlatformNintendo, OSNintendo, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserYandex, Version{1, 0, 1084, "5402"},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{24, 0, 1295, "0"},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0, ""},
			},
	...
	// Can't parse due to limitation of user agent library
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{6, 5, 3, "5"},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{63, 0, 3239, "111"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{64, 0, 3282, "123"},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{45, 0, 2454, "84"},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 4, 2, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserNintendo, Version{4, 3, 1, "11264.us"},
			},
			OS{
				PlatformNintendo, OSNintendo, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				Name:    16,
				Version: Version{Major: 4, Minor: 3, Patch: 1, Extra: "11264.us"},
			},
			OS{
				PlatformNintendo, OSNintendo, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				Name:    6,
				Version: Version{Major: 28, Minor: 0, Patch: 1754, Extra: "0"},
			},
			OS{
				PlatformLinux, OSLinux, Version{0, 0, 0, ""},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				Name:    1,
				Version: Version{Major: 31, Minor: 0, Patch: 1650, Extra: "0"},
			},
			OS{
				PlatformLinux, OSAndroid, Version{0, 0, 0, ""},
			},
	...
	for _, determined := range testUAVars {
		t.Run("", func(t *testing.T) {
			...
			for _, f := range testFuncs {
				...
				// }
				if diff := cmp.Diff(determined.Browser, ua.Browser); diff != "" {
					t.Fatalf("Agent: %s\nBrowser mismatch want(-), got(+):\n%s", determined.UA, diff)
				}

				if diff := cmp.Diff(determined.OS, ua.OS); diff != "" {
					t.Fatalf("Agent: %s\nOS mismatch want(-), got(+):\n%s", determined.UA, diff)
				}
